        ...
        <div class="col-lg-4 bg-white border-end border-gray offcanvas-lg" id="sideDiv">
            <div class="row bg-primary d-flex align-items-center border-top border-white" style="height: 9vh">
                <div class="col-2 sticky-top">
                    <a href="senior_home.php" class="text-white"><i class="fa-solid fa-arrow-left fa-2xl"></i></a>
                </div>
                <div class="col-8" id="">
            ...
            <div class="col-12">
<?php
    $chat_sql = mysqli_query($conn, "SELECT *  FROM admin_tbl");
    while($row = mysqli_fetch_assoc($chat_sql)){
?>
    <a href="senior_message.php?message_id=<?= $row['message_id'] ?>" style="text-decoration:none; color: black;">
    <div class="row border-bottom border-gray">
        <div class="col-3 ratio ratio-1x1" style="width: 6vw">
            <img src="../admin/admin_pic/admin_pic.jpg" class="img-fluid" alt="">
        </div>
        <div class="col">
            <div class="row">
                <div class="col-9">
            ...
            <div class="row bg-primary border-top border-white pt-1 pb-1" style="height: 9vh">
                <div class="col-lg-1 col-2 d-flex align-items-center">
                    <div class="ratio ratio-1x1">
                        <img src="../admin/admin_pic/admin_pic.jpg" class="img-fluid rounded-circle border border-black" alt="">
                    </div>
                </div>
                <div class="col-8 text-white d-flex align-items-center">
                    <h3 class="align-self-center">Admin</h3>
                </div>
            </div>
            ...
            <div class="row">
                <form action="#" id="message-form" class="message-form" autocomplete="off">
                    <div class="input-group mb-3"> 
                        ...
                        <input type="text" value="<?= $_SESSION['senior_message'] ?>" name="outgoing" hidden>
