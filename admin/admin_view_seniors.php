            ...
            ?>
              <tr>
                ...
                <td class="align-middle">
                  <a href="admin_senior_acc.php?id=<?= $row['senior_id'] ?>" class="btn btn-sm btn-primary btn-block text-white">View Senior</a><buttons href="" class="btn btn-sm btn-danger btn-block text-white" id="deleteBtn">Delete Senior</buttons>
                </td>
              </tr>
            <?php
              }
