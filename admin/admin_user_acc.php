    ...
    <div class="container-fluid">
      ...
      <div class="row g-5 pt-3 order-sm-1" id="navbarSupportedContent" style="">
        <?php
          ...
          $sql = $conn->prepare("SELECT * FROM emp_tbl E RIGHT JOIN purok_tbl P ON E.purok_id=P.purok_id RIGHT JOIN barangay_tbl B ON E.barangay_id=B.barangay_id RIGHT JOIN municipality_tbl M ON E.municipality_id=M.municipality_id RIGHT JOIN province_tbl Pr ON E.province_id=Pr.province_id WHERE emp_id=?");
        ...
        <div class="col-lg-6 order-2 order-xl-1 order-lg-1 order-sm-2 shadow pt-4 bg-white rounded overflow-auto">
          <a href="admin_view_users.php"><i class="fa-solid fa-arrow-left fa-2xl float-start text-primary"></i></a>  
          <div class="row d-flex justify-content-center">
            <div class="col-5">
              <div class="ratio ratio-1x1 border border-dark">
                <img class="img-fluid" src="../user/user_pics/<?= $row['id_pic'] ?>" alt="">
              </div>
            </div>
          </div>
          <div class="row">
        ...
        <div class="col-lg-3 col-sm-12 order-1 order-xl-2 order-sm-1 d-flex flex-column gap-3">
            <buttons type="button" class="btn btn-danger text-white" id="deleteBtn">Delete User <i class="fa-solid fa-trash"></i></buttons>
        </div>
      </div>
      <!-- first row ends here -->
