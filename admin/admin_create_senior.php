...
?>
    ...
    <div class="container-sm bg-white mt-4 mb-4 p-5 rounded-3 overflow-auto" style="">
        ...
        <div class="row">
            <div class="col">
                <a href="admin_view_seniors.php"><i class="fa-solid fa-arrow-left fa-2xl"></i></a>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="admin_add_senior.php" method="post" id="submit" class="d-flex flex-column gap-2 needs-validation" style="height: 43vh;" enctype="multipart/form-data" novalidate>
