...
<?php
  ...
  $id_pic = $conn->prepare("SELECT id_pic FROM emp_tbl WHERE emp_id=?");
...
<div class="col-lg-3 sticky-top">
    <div class="offcanvas-lg offcanvas-start"  id="sideDiv">
        <ul class="nav nav-pills flex-column gap-3 side_menu_left">
          <li class="nav-item">
            <a class="nav-link <?= $active === "actProfile" ? "active":""; ?> fs-5" aria-current="page" href="emp_profile.php"><img src="user_pics/<?= $row['id_pic'] ?>" alt="" class="img-fluid ratio ratio-1x1 rounded-circle" style="width: 3vw"> Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= $active === "actHome" ? "active":""; ?> fs-5" aria-current="page" href="emp_home.php"><i class="fa-solid fa-home fa-xl"></i> Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= $active === "actSenior" ? "active":""; ?> fs-5" href="emp_view_seniors.php"><i class="fa-solid fa-person-cane fa-xl"></i>  Seniors</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= $active === "actRequest" ? "active":""; ?> fs-5" href="emp_requests.php"><i class="fa-solid fa-file fa-xl"></i> Requests</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= $active === "actEvent" ? "active":""; ?> fs-5" href="emp_event_logs.php"><i class="fa-solid fa-book fa-xl"></i> Senior Logs</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= $active === "actActivities" ? "active":""; ?> fs-5" href="emp_activities.php"><i class="fa-solid fa-person-walking fa-xl"></i>   Activites</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= $active === "actMessage" ? "active":""; ?> fs-5" href="emp_message.php"><i class="fa-solid fa-message fa-xl"></i>   Messages</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fs-5" href="../emp_logout.php"><i class="fa-solid fa-arrow-right-from-bracket fa-xl"></i> Logout</a>
          </li>
        </ul>
    </div>
</div>
