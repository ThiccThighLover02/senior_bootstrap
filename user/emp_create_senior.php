...
<body class="overflow-hidden" style="background-image: url('../munisipyobckgrnd.jpg'); background-size: cover;">
    ...
    <div class="container-sm bg-white mt-4 p-5 rounded-3 overflow-auto" style="">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="emp_add_senior.php?add_senior=true" method="post" id="submit" class="d-flex flex-column gap-2 needs-validation" style="height: 43vh;" enctype="multipart/form-data" novalidate>
                  ...
                  <div class="form-group d-flex flex-column">
                    ...
                    <div class="col-12 mb-3">
                        <!-- BithDate -->
                        <input type="date" name="date_birth" class="form-control form-control-lg birth_date" id="birth_date" placeholder="" required>
                        <label for="" class="invalid-feedback mb-1">Require</label>
                    </div>
                    <div class="col-12 mb-3">
                        <!-- BirthPlace -->
                        <input type="text" name="place_birth" class="form-control form-control-lg" id="" placeholder="Birthplace" required>
                        <label for="" class="invalid-feedback mb-1">Require</label>
                    </div>
                    <div class="col-12 mb-3">
                        <!-- Citizenship -->
                  ...
                  <input type="submit" class="btn btn-primary btn-block" value="Add Senior">
